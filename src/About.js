...
function About(props) {
    ...
    return (
        <>
        <NavigationBar />
        <Container className='about-container'  data-aos='fade-up' data-aos-duration='2000'>
            ...
            <h1 className='mb-5' style={{fontWeight:'lighter',fontSize:'3.5em',color: '#3d4460',marginTop:'105px',textAlign:'center'}}  data-aos='fade-down' data-aos-duration='2000' >Meet The Team</h1>
            <Carousel variant="dark" interval={null}  data-aos='fade-down' data-aos-duration='2000'>
                <Carousel.Item >
                    <img
                 ...
                 <Carousel.Caption className='m-3 text-center' style={{position:'static'}}>
                    ...
                    <p> <a href='https://www.linkedin.com/in/fahad-al-araik-6a3676225/' className='p-2 about-icon' target='_blank'><BsLinkedin style={{height:'24px',width:'24px'}}/></a> 
                        <a href='https://twitter.com/fahad_alaraik' className='p-2 about-icon' target='_blank'><BsTwitter style={{height:'24px',width:'24px'}}/></a>
                     </p>
                    </Carousel.Caption>
                ...
                <p> <a href='https://www.linkedin.com/in/nawafsubaie/' className='p-2 about-icon' target='_blank'><BsLinkedin style={{height:'24px',width:'24px'}}/></a> 
                    <a href='https://twitter.com/Nawafsuu' className='p-2 about-icon' target='_blank'><BsTwitter style={{height:'24px',width:'24px'}}/></a>
                </p>
                    </Carousel.Caption>
            ...
            <Container style={{marginTop:'65px',padding:'35px 35px 35px 35px',background:'rgb(237 239 243 / 68%)',borderRadius:'35px'}} data-aos='fade-up' data-aos-duration='2000'>
