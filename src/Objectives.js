    ...
    return (
        <Container fluid style={{background:'#E2ECF0',marginTop:'125px',paddingBottom:'85px',paddingTop:'50px'}} id='objectives'>
            <Row className='text-center justify-content-center Poppins pt-5 pb-4'>
                <h1 style={{color:'#007096'}} data-aos="fade-in"  data-aos-duration='1500'><strong>Objectives</strong></h1>
            </Row>
            <Row className='justify-content-center text-center pb-3'>
                <Col className='mt-5 pt-3' data-aos="fade-in"  data-aos-duration='3000'>
                ...
                <Col className='mt-5 pt-3 text-center' data-aos="fade-in"  data-aos-duration='3000'>
